                ...
                <div id="content">
                    ...
                    <div className="timeline">
                        ...
                        <div className="accomplishment">
                            <h1 className="date">May 8, 2019</h1>
                            <h1 className="info">I learned how to make and use a basic Makefile, and used it for my project <a href="/work/kogit" target="_blank">Kogit</a>.</h1>
                        </div>

                        <div className="accomplishment right">
                            <h1 className="date">May 3, 2019</h1>
                            <h1 className="info">I started learning bash scripting and began work on developing my first bash script, <a href="/work/kogit" target="_blank">Kogit</a>.</h1>
                        </div>

                        <div className="accomplishment">
                            <h1 className="date">April 17, 2019</h1>
                            <h1 className="info">I setup an SSL certificate from <a href="https://letsencrypt.org/" target="_blank">Let's Encrypt</a> for my project <a href="/work/geola" target="_blank">Geola</a>'s website, as well as for this website.</h1>
                        </div>

                        <div className="accomplishment right">
                            <h1 className="date">April 16, 2019</h1>
                            <h1 className="info">I deployed this website on my VPS, which involved Nginx server blocks (virtual hosts), since I already had my other project <a href="/work/geola" target="_blank">Geola</a>'s website hosted on my VPS too.</h1>
                        </div>
