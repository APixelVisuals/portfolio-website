        ...
        return (
            <div id="work_apixel-visuals">
                ...
                <div id="content">
                    ...
                    <h1 className="info">I made this website mainly to showcase my work to potential clients (maybe that's you?), as well as anyone else who might be interested in the things I make.</h1>
                    <h1 className="info">One thing I love about this website is that it's my own. That means that I can add a bunch of Easter eggs around it. Seriously, it's actually kinda fun making them.</h1>
